...
class Environment extends MainClient {
    ...
    init() {
        ...
        var time = Math.floor(Math.random() * (120000 - 1000 + 1)) + 1000 // Random time between 1000 ms and 120000 ms
        // var size = parseInt(Konekti.vc('size').value) // Size of the reversi board
        //var size = 10 // variable tamaño de tablero
        var size = Math.floor(Math.random() * (20 - 3 + 1)) + 3 // Random size of the board between 3 and 20
